...
-- ============================================================
-- SEED DATA: isi awal menu (19 item)
-- ============================================================
insert into menu_items (nama, deskripsi, harga, kategori, ikon, andalan, urutan) values
  ...
  ('Teh Tarik',        'Teh hitam kuat ditarik dengan susu kental manis, berbusa dan harum.',                    9000,  'non-kopi', '🍵', false, 9),
...
-- ============================================================
-- REALTIME: supaya pesanan baru langsung muncul di admin tanpa refresh
-- ============================================================
-- Menambahkan tabel "orders" ke publication realtime Supabase.
-- Aman dijalankan berulang kali (skip kalau sudah ada).
do $$
begin
  if not exists (
